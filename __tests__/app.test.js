...
describe('API Routes', () => {
  ...
  const expectedItems = [
    ...
    },
    {
      ...
      type: 'Wondrous iem', 'rarity': 'uncommon'
    },
    {
      name: 'Candle of Invocatin',
    ...
    },
    {
      ...
      description: 'This book descriptionribes fitness exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book\'s contents and practicing its guidelines, your Strength score increases by 2, as does your maximum for that score. The manual then loses its magic, but regains it in a century.',
      type: 'Wondrous item',
      rarity: 'very rare'
    },
    {
    ...
    },
    {
      ...
      description: 'When you fall while wearing this ring, you descriptionend 60 feet per round and take no damage from falling.',
      type: 'Ring',
      rarity: 'rare',
      requiresAttunement: true
    },
    ...
    {
      name: 'Winged Boots',
      description: 'While you wear these boots, you have a flying speed equal to your walking speed. You can use the boots to fly for up to 4 hours, all at once or in several shorter flights, each one using a minimum of 1 minute from the duration. If you are flying when the duration expires, you descriptionend at a rate of 30 feet per round until you land.\n\nThe boots regain 2 hours of flying capability for every 12 hours they aren\'t in use.',
      type: 'Wondrous item',
      rarity: 'uncommon',
      requiresAttunement: true
    },
